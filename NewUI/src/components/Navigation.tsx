...
const Navigation = () => {
  ...
  const navItems = location.pathname === '/ipad-reseller' 
    ...
    : [
        ...
        { name: "Quick Start", href: "#pricing", onClick: () => scrollToSection('pricing') },
        { name: "Live Streams", href: "#testimonials", onClick: () => scrollToSection('testimonials') },
      ...
      <div className="mx-auto h-full px-6">
        <nav className="flex items-center justify-between h-full">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-base">Streamyyy</span>
          </div>
