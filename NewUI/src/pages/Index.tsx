        ...
        <div className="flex flex-col items-center text-center relative z-10">
          ...
          <motion.div initial={{
            ...
            <span className="text-sm font-medium">
              ...
              Enterprise Security • Industry Leading • Zero Lag Guarantee
            </span>
          </motion.div>
          ...
          <div className="max-w-4xl relative z-10">
            ...
            <motion.p initial={{
              ...
              <span className="text-white">Monitor up to 16 streams simultaneously from all platforms.</span>
            </motion.p>
          ...
          >
            <div className="glass rounded-xl p-8 bg-transparent">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                ...
                <div>
                  <div className="text-3xl font-bold text-primary mb-2">16x</div>
                  <div className="text-sm text-gray-400">Max Streams</div>
                </div>
              </div>
            </div>
          </motion.div>
